...
class NoteDetailsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        addSaveNotificationObserver()   //L6-20
    }
...
extension NoteDetailsViewController: UITextViewDelegate {
    func textViewDidEndEditing(_ textView: UITextView) {
        ...
        //try? note.managedObjectContext?.save() // equal to below as long as we set dataController at NotesListVC prepare func
...
extension NoteDetailsViewController {
    ...
    @IBAction func cowTapped(sender: Any) {
        ...
        let noteID = note.objectID      //L6-19
        
        dataController?.backgroundContext.perform {    //L6-19
            ...
            //sleep(3) //for test slow work only
...
//L6-20
extension NoteDetailsViewController { // "add/delete notification observer and handle notification" total 3 methods in here
    ...
    func removeSaveNotificationObserver(){
        if let token = saveObserverToken { // if this property has value then delete it
